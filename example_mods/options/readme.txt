...
To prevent unloaded saved options prefs: loadJsonOptions([If you'd like to include the main global mods folder], [The names of the Mods' Options' (Mods' Folder) as array])
Note that:
