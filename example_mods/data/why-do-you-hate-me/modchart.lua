...
--end 
    ...
    if step == 1014 then 
        ...
        tweenFadeIn(5, 0, 0.05)
        tweenFadeOut(0, 1, 0.05)
        tweenFadeOut(7, 1, 0.05)
    end
    if step == 1017 then 
    ...
    if step == 1020 then 
        ...
        for i = 0, 3 do 
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 90, getActorAngle(i), 0.5, 'setDefaultX')
        end
        for i = 4, 7 do 
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 90, getActorAngle(i), 0.5, 'setDefaultX')
        end
...
-- diagonal arrows again 
    ...
    if step == 1336 then 
        for i = 0, 3 do 
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 550, getActorAngle(i), 0.40, 'setDefaultX')
        end
        for i = 4, 7 do 
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 550, getActorAngle(i), 0.40, 'setDefaultX')
        end
...
--ending!!!!
    if step == 2688 then 
        ...
        tweenPosXAngle(4, _G['defaultStrum4X'] - 320,getActorAngle(4) + 360, 13.68, 'setDefaultX')
        tweenPosXAngle(5, _G['defaultStrum5X'] - 260,getActorAngle(5) + 360, 13.68, 'setDefaultX')
        tweenPosXAngle(6, _G['defaultStrum6X'] + 260,getActorAngle(6) + 360, 13.68, 'setDefaultX')
        tweenPosXAngle(7, _G['defaultStrum7X'] + 320,getActorAngle(7) + 360, 13.68, 'setDefaultX')
    end
    if step == 2842 then 
