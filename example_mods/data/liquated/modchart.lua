...
-- long note moving things P1
    ...
    if step == 96 then 
        ...
        tweenFadeOut(7, 1, 1.71)
        for i = 4, 7 do 
            tweenPosYAngle(i, _G['defaultStrum'..i..'Y'] + 80, getActorAngle(i), 1.70, i)
        end
    end
    if step == 112 then 
        tweenFadeIn(7, 0, 0.85)
...
-- long notes moving things P2
    ...
    if step == 160 then 
        ...
        tweenFadeOut(0, 1, 1.71)
        for i = 0, 3 do 
            tweenPosYAngle(i, _G['defaultStrum'..i..'Y'] + 80, getActorAngle(i), 1.70, i)
        end
    end
    if step == 176 then 
        tweenFadeIn(2, 0, 0.85)
        tweenFadeIn(0, 0, 0.85)
        tweenFadeOut(1, 1, 0.85)
        tweenFadeOut(3, 1, 0.85)
        for i = 0, 3 do 
            tweenPosYAngle(i, _G['defaultStrum'..i..'Y'] - 40, getActorAngle(i), 0.85, i)
        end
    end
    if step == 184 then 
        tweenFadeOut(0, 1, 0.85)
...
-- blinking for long note moving things P1 part 2
    -- left arrow 
    if step == 200 or step == 230 or step == 240 then 
        tweenFadeOut(4, 1, 0.70)
    end
    if step == 239 then 
        tweenFadeIn(4, 0, 0.30)
    end
    -- down arrow 
    if step == 198 or step == 242 or step == 240 then 
        tweenFadeOut(5, 1, 0.70)
    end
    if step == 207 or step == 243 or step == 247 then 
        tweenFadeIn(5, 0, 0.30)
    end
    -- up arrow 
    if step == 218 or step == 230 or step == 240 then 
        tweenFadeOut(6, 1, 0.70)
    end
    if step == 247 then 
        tweenFadeIn(6, 0, 0.30)
    end
    -- right arrow 
    if step == 214 or step == 240 then 
        tweenFadeOut(7, 1, 0.70)
    end
    if step == 203 or step == 223 then 
        tweenFadeIn(7, 0, 0.30)
    end
...
-- hehe more funny moving arrows funny
    ...
    if step == 764 then 
        tweenPosXAngle(0, _G['defaultStrum0X'] - 320,getActorAngle(0), 0.3, 'setDefaultX')
        tweenPosXAngle(1, _G['defaultStrum1X'] - 260,getActorAngle(1), 0.3, 'setDefaultX')
        tweenPosXAngle(2, _G['defaultStrum2X'] + 260,getActorAngle(2), 0.3, 'setDefaultX')
        tweenPosXAngle(3, _G['defaultStrum3X'] + 320,getActorAngle(3), 0.3, 'setDefaultX')
    end
    if step == 768 then 
        for i = 0, 3 do 
