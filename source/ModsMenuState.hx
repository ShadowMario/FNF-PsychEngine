...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		noModsTxt = new FlxText(0, 0, FlxG.width, "NO MODS HAVE BEEN INSTALLED\nPRESS BACKSPACE TO EXIT AND INSTALL A MOD IN...", 48);
		if(FlxG.random.bool(0.1)) noModsTxt.text += '\nBITCH.'; //meanie
		noModsTxt.setFormat(Paths.font("PhantomMuff.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		buttonToggle.label.setFormat(Paths.font("PhantomMuff.ttf"), 24, FlxColor.WHITE, CENTER);
		...
		buttonUp.label.setFormat(Paths.font("PhantomMuff.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDown.label.setFormat(Paths.font("PhantomMuff.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonTop.label.setFormat(Paths.font("PhantomMuff.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDisableAll.label.setFormat(Paths.font("PhantomMuff.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonEnableAll.label.setFormat(Paths.font("PhantomMuff.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		descriptionTxt.setFormat(Paths.font("PhantomMuff.ttf"), 32, FlxColor.WHITE, LEFT);
