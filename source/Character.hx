...
class Character extends FlxSprite
{
	...
	var isNoteOffset:Bool = false;

	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false, ?isNoteOffset:Bool = false)
	{
		super(x, y);

		this.isNoteOffset = isNoteOffset;
