...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function spawnNotes()
	{
		...
		for (i in 0...dataArray.length)
		{
			...
			newNote.texture = 'NOTE_assets'; // going into a song with custom note skin annd coming back to the menu would kill it for some reason
		...
		bigNote.texture = 'NOTE_assets'; // read comment above
