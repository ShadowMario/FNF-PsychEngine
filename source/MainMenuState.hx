...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, ClientPrefs.getResolution()[1] - 64, 0, "Fat-Ass Mod Compilation v" + fatassVersion, 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://github.com/MeguminBOT/FNF-PsychEngine-ModCompilation/releases');
				}
				else
				{
					selectedSomethin = true;
