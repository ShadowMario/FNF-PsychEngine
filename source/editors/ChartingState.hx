...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSectionUI():Void
	{
		...
		stepperLength.value = _song.notes[curSec].sectionBeats;
	...
	function updateWaveform() {
		...
		var steps:Float = _song.notes[curSec].sectionBeats;
	...
	function updateSectionUI():Void
	{
		...
		stepperLength.value = sec.sectionBeats;
