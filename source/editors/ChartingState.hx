...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Missile Warning', 'Value 1: Which note the missile is coming at.\nUse 0 - 3 to pick which note.\n0 is left, 1 is down, 2 is up, and 3 is right.'],
		['Slide In/Out', 'Value 1: Dad or BF, 0 is BF and 1 is Dad.\nValue 2: In or out, 0 is in and 1 is out.']
	];
