...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [ // Now actually tells the truth about your accuracy without being too harsh on your feelings. //Lulu
		['Uninstall', 0.2], //From 0% to 20%
		['Laughable', 0.75], //From 20% to 75%
		['Horrible', 0.8], //From 75% to 80%
		['Bad', 0.85], //From 80% to 85%
		['OK', 0.9], //From 85% to 90%
		['Decent', 0.95], //From 90% to 95%
		['Good', 0.98], //From 95% to 98%
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("roboto.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("roboto.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("roboto.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
