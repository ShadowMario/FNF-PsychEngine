package;//if you see this, i will leave random comments
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (!stageData.hide_girlfriend && !ClientPrefs.optimize)
		{
		...
		//it said here "A destroyed FlxBasic can't be used anymore. It may even cause crashes if it is still part of a group or state. You may want to use kill() instead if you want to disable the object temporarily only and revive() it later."
		//will it break again?????
		// Future me: Had to use remove() will it break again
		// Furte me Part 2: just pretend their away
		if(ClientPrefs.optimize)
		{
			//remove(dad);
			//remove(boyfriend);
