...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if(SONG.stage == null || SONG.stage.length < 1) {
			switch (songName)
			{
				case 'maid' | 'shittera-shitte' | 'dragon-power':
					curStage = 'tohru-livingroom';
				default:
					curStage = 'stage';
			}
		}
		...
		switch (curStage)
		{
			case 'stage': //Week 1 Nota: Dejo el Stage de Daddy Dearest para evitar posibles bugs
			...
			case 'tohru-livingroom': //Week de Tohru
				var bg:BGSprite = new BGSprite('backgrounds/tohru-livingroom', -20, -10, 1.0, 1.0);
				add(bg);

				if (Paths.formatToSongPath(SONG.song) == 'maid' || Paths.formatToSongPath(SONG.song) == 'shittera-shitte' || Paths.formatToSongPath(SONG.song) == 'dragon-power'){
					camZooming = true;		
				}
		}
