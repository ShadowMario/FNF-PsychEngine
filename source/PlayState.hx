...
class PlayState extends MusicBeatState
{
	...
	public var inGameCutscene:Bool = false; //seperated for the week 7 cutscenes, if this isn't necessary feel free to change it, this is referenced in lines 1812, 2092, and 3178
