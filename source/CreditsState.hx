...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Roxbeige',			'generic',			'Charter, Playtesting, Being a Fat-ass',				'https://www.youtube.com/channel/UCaHN6LutYv6wGZkuplqcQyw',		'DAF7A6'],		
			[''],
			['Psych Engine Team'],
		...
		descText.setFormat(Paths.font("rubik.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
