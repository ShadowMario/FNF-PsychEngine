...
class NoteSplashEditorState extends MusicBeatState
{
    ...
    function addAnimTab()
    {
        ...
        var templateButton:PsychUIButton = new PsychUIButton(-110, 160, "Template", function()
        {
    ...
    function addProperitiesTab()
    {
        ...
        var saveButton:PsychUIButton = new PsychUIButton(20, 160, "Save", function()
        {
            saveSplash();
        });
        ui.add(saveButton);
        ...
        var getsAffectedByShader:PsychUICheckBox = new PsychUICheckBox(20, 110.5, "", 1);
        function check()
        {
            if (config != null)
            {
