	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['StefanBETA Engine Od'], 15);
					#else
				...
				case 4:
					...
					addMoreText('MatejaMorixs', 15);
					addMoreText('MihajloMOXI', 15);
					#else
					addMoreText('Predstavljaju');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['Nisam Partner', 'Sa'], -40);
					#else
					createCoolText(['Ja Sam Partner', 'Sa'], -40);
					#end
				case 8:
