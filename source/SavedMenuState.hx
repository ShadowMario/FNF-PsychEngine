...
class SavedMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var colorsList = ['0xFF0069FF', '0xFFFF1900', '0xFF00FF15'];
		...
		DiscordClient.changePresence("Browsing saved weeks", null);
		#end
		...
		textBG.alpha = 0.6;
		add(textBG);
		var leText:String = "Press ACCEPT to select a option / Press BACK to go back";
