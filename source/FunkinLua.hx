...
class FunkinLua
{
	...
	public function new(script:String)
	{
		...
		Lua_helper.add_callback(lua, "setCustomOption", function(optionName:String, value:Dynamic)
		{
			Reflect.setField(ClientPrefs.data, optionName, value);
			ClientPrefs.saveCustomSettings();
			return;
		});
		Lua_helper.add_callback(lua, "getCustomOption", function(optionName:String)
		{
			ClientPrefs.loadCustomSettings();
			var returnThing = Reflect.getProperty(ClientPrefs.data, optionName);
			if (returnThing == null)
				returnThing = "null";
			return returnThing;
		});
