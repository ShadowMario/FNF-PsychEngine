...
class Timeline
{
	...
	**/
	...
	@:noCompletion private var __currentFrame:Float;
	...
	@:noCompletion private var __framesLoaded:Float;
	@:noCompletion private var __frameTime:Float;
	@:noCompletion private var __isPlaying:Bool;
	@:noCompletion private var __lastFrameScriptEval:Float;
	@:noCompletion private var __lastFrameUpdate:Float;
	@:noCompletion private var __scope:MovieClip;
	@:noCompletion private var __timeElapsed:Float;
	@:noCompletion private var __totalFrames:Float;
	...
	**/
	@:noCompletion public function enterFrame(frame:Float):Void {}
	...
	**/
	...
	@:noCompletion private function __evaluateFrameScripts(advanceToFrame:Float):Bool
	{
		if (__frameScripts == null) return true;

		for (frame in Std.int(__currentFrame)...Std.int(advanceToFrame) + 1)
		{
			if (frame == Std.int(__lastFrameScriptEval)) continue;
	...
	@:noCompletion private function __goto(frame:Float):Void
	{
		if (frame < 1) frame = 1;
	...
	@:noCompletion private function __resolveFrameReference(frame:#if (haxe_ver >= "3.4.2") Any #else Dynamic #end):Float
	{
		if ((frame is Float))
		{
			return cast frame;
	...
	@:noCompletion private function __updateSymbol(targetFrame:Float):Void
	{
