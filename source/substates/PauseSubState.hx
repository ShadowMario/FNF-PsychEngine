...
class PauseSubState extends MusicBeatSubstate
{
	...
	function updateSkipTimeText()
		skipTimeText.text = CoolUtil.formatTime(Math.max(0, Math.floor(curTime / 1000)), false) + ' / ' + CoolUtil.formatTime(Math.max(0, Math.floor(FlxG.sound.music.length / 1000)), false);
}
