...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Freaky on a Friday Night",	"dying on a friday day.",						'friday_night_play',	 true],
		["man you still suck",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["tiky",				"Beat Week 2 on Hard with alot and i mean alot of Misses.",				'week2_nomiss',			false],
		["hey this stupid furry smells",			"Beat Week jimmy sucks fuck him on Hard with no Misses.",				'week3_nomiss',			false],
